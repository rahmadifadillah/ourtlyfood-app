...
class Admin extends CI_Controller
{
	...
	function tambah_mitra()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$this->model_app->insert('tb_toko_mitra', $data);
	...
	function edit_mitra()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$this->model_app->update('tb_toko_mitra', $data, $where);
			redirect('admin/mitra');
		} else {
	...
	function delete_mitra($id)
	{
		...
		$this->model_app->delete('tb_toko_mitra', $where);
		echo json_encode(array("status" => TRUE));
	}
