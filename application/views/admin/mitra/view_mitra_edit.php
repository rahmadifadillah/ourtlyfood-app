      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form action="<?= base_url('admin/edit_mitra'); ?>" method="post">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type='text' class='form-control' name='a' value='<?= $rows['nama_mitra']; ?>' required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href='<?= base_url('admin/mitra'); ?>'><button type='button' class='btn btn-secondary btn-sm ml-1'>Batal</button></a>
                  </div>
                </div>
